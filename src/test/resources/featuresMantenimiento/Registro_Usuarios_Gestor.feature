Feature: El gestor puede registrar usuarios
  ...
  |	 dni	| nombre	 | apellidos   | pwd 	 | numTelefono    | email   |  centro     | resultadoEsperado 	 | especialidad   |
  | <dni> | <nombre> | <apellidos> | <pwd> | <numTelefono>  | <email> |	Sta Prueba	| <resultadoEsperado>  | <especialidad> |
